...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center w-full px-8 py-4 bg-zinc-900 border-b border-zinc-800">
      <div className="flex flex-col gap-1">
        <h1 className="text-xl font-bold text-white">
          Bixbia,{" "}
          <span className="font-extrabold">connecting to playstation</span>
        </h1>
        <div className="flex items-center gap-2 mt-1">
          ...
          <span
            className="ml-2 w-24 h-1 bg-gradient-to-r from-blue-400 via-pink-400 to-purple-400 rounded-full"
            aria-hidden="true"
          />
        </div>
        {/* XP Progress Bar */}
        <div className="mt-2 flex flex-col gap-1 w-64 max-w-xs">
          ...
          >
            <div
              className="h-full bg-gradient-to-r from-pink-400 via-blue-400 to-purple-400 transition-all"
      ...
      <div className="flex items-center gap-3">
        ...
        <span
          className="text-white text-sm hidden md:inline"
